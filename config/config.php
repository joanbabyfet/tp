...
return [
    ...
    //短信
    'unimtx' => [
        'access_key'     => env('UNIMTX_ACCESS_KEY', ''),      //开发者ID
        'access_secret'  => env('UNIMTX_ACCESS_SECRET', ''),   //开发者密钥
    ],
    //推送
    'firebase' => [
        'key_path'  => app()->getRootPath().env('FIREBASE_CREDENTIALS'),
    ...
    //允许图片格式
    'allow_exts' => 'jpeg|jpg|gif|png|bmp',
    'upload_max_size' => 5,
    //上传目录数量, 默认128
    'dir_num' => 128,
    //图片域名，实际部署时换成自己的域名
